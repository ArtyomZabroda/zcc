...
enum TokenType {
  TOKEN_TYPE_UNKNOWN, TOKEN_TYPE_EOF, TOKEN_TYPE_IDENTIFIER, TOKEN_TYPE_NUMERIC_CONSTANT, TOKEN_TYPE_CHAR_CONST, TOKEN_TYPE_STRING_LITERAL,

  TOKEN_TYPE_LSQUARE, TOKEN_TYPE_RSQUARE, TOKEN_TYPE_LPAREN, TOKEN_TYPE_RPAREN, TOKEN_TYPE_PERIOD, TOKEN_TYPE_ARROW,
  TOKEN_TYPE_PLUS_PLUS, TOKEN_TYPE_MINUS_MINUS, TOKEN_TYPE_AMP, TOKEN_TYPE_PLUS, TOKEN_TYPE_MINUS, TOKEN_TYPE_TILDE,
  ...
  TOKEN_TYPE_PIPE_EQUAL, TOKEN_TYPE_COMMA, TOKEN_TYPE_HASH, TOKEN_TYPE_HASH_HASH
};
